...
export const SITUATIONS: SituationCard[] = [
  ...
  },
  {
    ...
    immediateAction: 'Fjern unødvendige valg. Legg fram to par sokker eller plagg i stedet for en hel skuff. Gjør det første steget sammen: hjelp til å holde buksebeinet.',
    sentenceToSay: 'Dette ble skikkelig tungt i dag. Jeg hjelper deg i gang. Vi tar ett buksebein først, så klarer du det neste.',
  ...
  },
  {
    ...
    underTheHood: 'Overganger krever at en pågående impuls stanses brått for å starte en ny. For et uferdig styringssystem er det mentale sporskiftet kjempekrevende.',
